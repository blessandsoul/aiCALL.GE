...
const COPY = {
  ka: {
    eyebrow: 'aiCALL-ის სამუშაო ტესტები',
    title: 'ბლოგი',
    subtitle: 'ქართული AI ზარების ტესტები, შედეგების განმარტება და ადამიანთან გადართვის მკაფიო წესები.',
    latest: 'ყველა მასალა',
    read: 'წაიკითხეთ',
  ...
  en: {
    eyebrow: 'Practical guides by aiCALL',
    title: 'Blog',
  ...
  ru: {
    eyebrow: 'Практические материалы aiCALL',
    title: 'Блог',
